...
public class PeopleController {
    ...
    @Operation(
        ...
        description = "Return list of people registered in the system register in the system."
    )
    @ApiResponses({
    @ApiResponse(
            responseCode = "200",
    ...
    @io.swagger.v3.oas.annotations.parameters.RequestBody(
        description = "Person data regsitered correctly",
        required = true,
        content = @Content(
            mediaType = "application/json",
            schema = @Schema(implementation = PeopleResponseDTO.class)
    ...
    public ResponseEntity<?> deletePeople(@PathVariable Long id){
        ...
        try{
            ...
            return ResponseEntity.ok(this.service.deletePeople(id));
